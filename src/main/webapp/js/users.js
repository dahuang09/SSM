...
var tree = new Ext.tree.TreePanel({
        //el:'userstree',
    loader:new Ext.tree.TreeLoader({dataUrl:'js/userstree.txt'}),
    title:'菜单',
    iconCls:'settings',
    region:'west',
    width:200,
                ...
                if (!n) {
                    n = contentPanel.add( {
                                ...
                                iconCls:'tabs',
                                    'title' : node.text,
                                closable : true,
                                html : '<iframe name="Sub" scrolling="auto" frameborder="0" width="100%" height="100%" src="common/return.jsp"></iframe>'
                            });
                }
            }
