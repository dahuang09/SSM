                            ...
                            if (!n)	{
                                n = contentPanel.add( {
                                                ...
                                                iconCls:'tabs',
                                                    'title' : node.text,
                                                closable : true,
                                                html : '<iframe name="Sub" scrolling="auto" frameborder="0" width="100%" height="100%" src="users/roomlist.jsp?flatid='+nodeId+'"></iframe>'
                                            });
                            }
                            contentPanel.setActiveTab(n);
    ...
    var viewport=new Ext.Viewport({
        ...
        items:[
               ...
               layout : 'fit',
                ...
                collapsible:true,
                height:65,
                html:'<iframe scrolling="auto" frameborder="0" width="100%" height="100%" src="./jsp/users/top.jsp"></iframe>'
